...
var keep_track_of_time;
function startTime(){

  var elapsed = document.getElementById("time");
  var seconds_elapsed = 0;

  keep_track_of_time = setInterval(() => {
    elapsed.innerHTML = "Time elapsed: " + seconds_elapsed;
    seconds_elapsed++;
  }, 1000)
    ...
    if (document.readyState == "complete") {
      ...
      function checkIfComplete() {
        ...
        if (check == "1234567891011121314150" && numberOfMoves > 20) {
          console.log("You win");
          clearInterval(keep_track_of_time);
          clearInterval();
          didwin = true;
          celebrate()
          return true;
